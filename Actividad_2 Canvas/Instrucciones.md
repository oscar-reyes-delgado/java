### Actividad 2
## Descripcion
En esta actividad, profundizarás en varios temas esenciales de programación en Java; por ejemplo, explorarás el manejo de cadenas de texto (Strings), estructuras de selección y de repetición, así como arreglos. Estos conceptos te proporcionarán herramientas fundamentales para desarrollar aplicaciones más complejas y versátiles.

## Objetivo:
Aplicar los conocimientos adquiridos relacionados con Strings, estructuras de selección y de repetición, así como arreglos, en el lenguaje de programación Java; asimismo, diseñar y crear programas que manejen cadenas de texto, tomen decisiones, realicen repeticiones y utilicen arreglos para resolver problemas prácticos.
